                ...
                <Sider trigger={null} collapsible collapsed={this.state.collapsed}>
                    ...
                    <Menu theme="dark" mode="inline" defaultSelectedKeys={['1']}>
                        <SubMenu key="sub1" title={<span><Icon type="setting" /><span>系统管理</span></span>}>
                            <Menu.Item key="1" onClick={() => this.switchItem("systemSettings")}>参数设置</Menu.Item>
                            <Menu.Item key="2" disabled={true}>系统状态</Menu.Item>
                        </SubMenu>
                        <SubMenu key="sub2" title={<span><Icon type="hdd" /><span>订单管理</span></span>}>
                            <Menu.Item key="3" onClick={() => this.switchItem("order")}>订单</Menu.Item>
                            <Menu.Item key="4" onClick={() => this.switchItem("trade")}>交易</Menu.Item>
                            <Menu.Item key="5" onClick={() => this.switchItem("report")}>报表</Menu.Item>
